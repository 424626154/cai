...
class GameBg extends egret.Sprite {
    ...
    public items: Array<ItemSprite> = new Array<ItemSprite>();
    public gameSprite: egret.Sprite;
    public timerText: egret.TextField;
    public bar: egret.Shape;
    public startSprite: egret.Sprite;
    public timer: egret.Timer;
    public endSprite: egret.Sprite;
    public initBg() {
    ...
    public addRow(col: number) {
        var selects: Array<boolean> = new Array<boolean>(true,false,false,false);
        var index1: number = GameData.random(0,GameData.err_texts.length);
        var err_text = GameData.err_texts[index1];
        for(var i = 0;i < GameData.row;i++) {
            var index: number = GameData.random(0,selects.length);
    ...
    public refreshBar() { 
        var colors: Array<number> = new Array<number>(0xec7979,0xeb6161,0xea4343,0xe82222,0xe60808);
        var color = colors[4];
    ...
    public onclikSatrt(event: egret.TouchEvent) { 
        var sound:egret.Sound = RES.getRes("button_click");
        sound.play(0,1);
        GameData.game_state = 2;
        this.removeChild(this.startSprite);       
        this.timer.start();
    }
    public onclikEnd(event: egret.TouchEvent) { 
        var sound:egret.Sound = RES.getRes("button_click");
        sound.play(0,1);
        GameData.game_state = 2;
        GameData.score = 0;
    ...
    public endGame() {         
        var sound:egret.Sound = RES.getRes("dialog_open");
        sound.play(0,1);
...
//        showTimerText.textColor = 0xff0000;
    ...
    public setWeixinShaseCustomInfo(){
